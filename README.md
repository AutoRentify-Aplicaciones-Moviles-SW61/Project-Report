...
| US02       | Actualización de Método de Pago<br><br>                            | TS03             | Crear formulario para actualizar método de pago.                               | Diseñar un formulario para ingresar nueva información de pago.                 | 2                 | Julio Esteban Elsner De La Torre Ugarte<br> | Done                                        |
|            |                                                                    | TS04             | Integrar funcionalidad con el proveedor de pagos.                              | Conectar con el sistema del proveedor para procesar actualizaciones.           | 3                 | Julio Esteban Elsner De La Torre Ugarte<br> | Done                                        |
| US03       | Visualización de Notificaciones<br>                                | TS05             | Implementar pantalla de visualización de notificaciones.                       | Crear una interfaz para mostrar notificaciones relevantes.                     | 2                 | Julio Esteban Elsner De La Torre Ugarte<br> | Done                                        |
|            |                                                                    | TS06             | Conectar backend para recibir notificaciones en tiempo real.                   | Configurar el servidor para enviar notificaciones en tiempo real.              | 2                 | Julio Esteban Elsner De La Torre Ugarte<br> | Done                                        |
| US04       | Visualización del Historial de Actividades                         | TS07             | Crear API para recuperar el historial de actividades del usuario.              | Desarrollar una API para solicitar el historial del usuario.                   | 3                 | Julio Esteban Elsner De La Torre Ugarte<br> | Done                                        |
|            |                                                                    | TS08             | Desarrollar interfaz para mostrar el historial de actividades.                 | Crear una interfaz que presente el historial de actividades.                   | 3                 | Julio Esteban Elsner De La Torre Ugarte<br> | Done                                        |
| US05       | Preferencias de Idioma<br>                                         | TS09             | Implementar selector de idioma en el perfil del usuario.                       | Agregar una opción para que los usuarios seleccionen su idioma.                | 1                 | Julio Esteban Elsner De La Torre Ugarte<br> | Done                                        |
|            |                                                                    | TS10             | Configurar traducción del contenido en base al idioma seleccionado.            | Integrar un sistema de traducción según el idioma elegido.                     | 1                 | Julio Esteban Elsner De La Torre Ugarte<br> | Done                                        |
| US06       | Gestión de Planes                                                  | TS11             | Desarrollar funcionalidad para cambiar entre distintos planes de usuario.      | Permitir a los usuarios cambiar su plan de suscripción.                        | 3                 | Christian Renato Espinoza Saenz<br>         | Done                                        |
|            |                                                                    | TS12             | Implementar lógica de actualización de planes en la base de datos.             | Actualizar la información del plan del usuario en la base de datos.            | 3                 | Christian Renato Espinoza Saenz<br>         | Done                                        |
| US07       | Registro de Nuevos Usuarios                                        | TS13             | Crear formulario de registro de nuevos usuarios.                               | Diseñar un formulario para que nuevos usuarios se registren.                   | 3                 | Christian Renato Espinoza Saenz<br>         | Done                                        |
|            |                                                                    | TS14             | Implementar validación de email y verificación de cuenta.                      | Validar emails y enviar enlace de verificación tras el registro.               | 3                 | Christian Renato Espinoza Saenz<br>         | Done                                        |
| US08       | Inicio de Sesión con Correo Electrónico y Contraseña               | TS15             | Desarrollar la lógica de autenticación para inicio de sesión.                  | Validar credenciales y gestionar acceso a la plataforma.                       |                   | Christian Renato Espinoza Saenz<br>         | Done                                        |
|            |                                                                    | TS16             | Implementar validaciones de seguridad para credenciales.                       | Proteger credenciales con medidas de seguridad adecuadas.                      | 2                 | Christian Renato Espinoza Saenz<br>         | Done                                        |
| US09       | Recuperación de Contraseña                                         | TS17             | Desarrollar la funcionalidad de recuperación de contraseña vía email.          | Permitir a los usuarios solicitar un enlace de recuperación.                   | 2                 | Christian Renato Espinoza Saenz<br>         | Done                                        |
|            |                                                                    | TS18             | Implementar token de recuperación y validación de contraseña nueva.            | Generar un token seguro para la recuperación de contraseña.                    | 2                 | Christian Renato Espinoza Saenz<br>         | Done                                        |
| US10       | Cierre de Sesión Seguro                                            | TS19             | Implementar el cierre de sesión seguro con eliminación de tokens.              | Eliminar sesiones y tokens al cerrar sesión.                                   | 2                 | Christian Renato Espinoza Saenz<br>         | Done                                        |
|            |                                                                    | TS20             | Crear pruebas de seguridad para evitar vulnerabilidades post logout.           | Verificar que no se acceda a información tras el cierre de sesión.             | 1                 | Christian Renato Espinoza Saenz<br>         | Done                                        |
| US11       | Selección de Punto de Recogida                                     | TS21             | Desarrollar mapa interactivo para selección del punto de recogida.             | Implementar un mapa para que los usuarios seleccionen la recogida.             | 3                 | Nelson Elías Serrano Ircañaupa              | Done                                        |
|            |                                                                    | TS22             | Implementar API para almacenar y validar punto de recogida.                    | Crear una API que gestione la ubicación seleccionada.                          | 2                 | Nelson Elías Serrano Ircañaupa              | Done                                        |
| US12       | Cambio de Punto de Recogida                                        | TS23             | Implementar lógica de actualización en el backend.                             | Diseñar una opción para que los usuarios cambien su recogida.                  | 2                 | Nelson Elías Serrano Ircañaupa              | Done                                        |
| US13       | Selección de Punto de Devolución                                   | TS24             | Implementar validación del punto de devolución seleccionado.                   | Permitir a los usuarios seleccionar un punto de devolución.                    | 3                 | Nelson Elías Serrano Ircañaupa              | Done                                        |
| US14       | Escribir Comentarios sobre el Vehículo Alquilado                   | TS25             | Desarrollar interfaz para escribir comentarios de vehículos.                   | Crear una sección para que los usuarios envíen comentarios.                    | 2                 | Nelson Elías Serrano Ircañaupa              | Done                                        |
|            |                                                                    | TS26             | Conectar la base de datos para almacenar los comentarios.                      | Implementar la lógica para almacenar comentarios en la base de datos.          | 1                 | Nelson Elías Serrano Ircañaupa              | Done                                        |
| US15       | Filtrado de Comentarios por Categoría                              | TS27             | Implementar lógica de filtrado por categoría en la base de datos.              | Crear consultas para filtrar comentarios por categoría.                        | 3                 | Nelson Elías Serrano Ircañaupa              | Done                                        |
| US16       | Valorar los comentarios de Otros Usuarios<br>                      | TS28             | Crear e implementar API para almacenar las valoraciones de los comentarios.    | Desarrollar la opción para que los usuarios den puntuaciones.                  | 3                 | Alvaro Felipe Pinto Fuentes Rivera          | Done                                        |
| US17       | Filtrar Vehículos por Tipo                                         | TS29             | Desarrollar lógica de filtrado de vehículos por tipo.                          | Crear un sistema para filtrar vehículos según tipo.                            | 2                 | Alvaro Felipe Pinto Fuentes Rivera          | Done                                        |
| US18       | Seleccionar Vehículo por Rango de Precio                           | TS30             | Implementar filtro de búsqueda por rango de precio.                            | Crear consultas para filtrar vehículos por precio.                             | 3                 | Alvaro Felipe Pinto Fuentes Rivera          | Done                                        |
|            |                                                                    | TS31             | Conectar el backend para devolver resultados filtrados por precio.             | Crear un componente para que los usuarios establezcan rango de precio.         | 2                 | Alvaro Felipe Pinto Fuentes Rivera          | Done                                        |
| US19       | Buscar Vehículos por Marca y Modelo                                | TS32             | Implementar la interfaz para mostrar los resultados de búsqueda.               | Desarrollar lógica para mostrar resultados tras una busqueda.                  | 2                 | Alvaro Felipe Pinto Fuentes Rivera          | Done                                        |
| US20       | Seleccionar Fecha y Hora de Inicio del Alquiler                    | TS33             | Desarrollar y conectar API para almacenar fecha y hora de inicio del alquiler. | Diseñar un calendario y selector de hora para elegir el inicio del alquiler.   | 2                 | Alvaro Felipe Pinto Fuentes Rivera          | Done                                        |
| US21       | Extender la Duración del Alquiler                                  | TS34             | Implementar lógica para extender la duración de un alquiler.                   | Permitir a los usuarios aumentar la duración del alquiler desde la aplicación. | 1                 | Joaquin David Rivadeneyra Ramos             | Done                                        |
| US22       | Reducir la Duración del Alquiler                                   | TS35             | Desarrollar funcionalidad para reducir la duración del alquiler.               | Permitir a los usuarios acortar la duración del alquiler desde la aplicación.  | 3                 | Joaquin David Rivadeneyra Ramos             | Done                                        |
| US23       | Gestión de Disponibilidad de Vehículos                             | TS36             | Implementar sistema para gestionar disponibilidad de vehículos.                | Crear un sistema que actualice la disponibilidad de vehículos en tiempo real.  | 2                 | Joaquin David Rivadeneyra Ramos             | Done                                        |
| US24       | Registro de Vehículos                                              | TS37             | Desarrollar formulario de registro de nuevos vehículos.                        | Diseñar un formulario que permita registrar nuevos vehículos en la plataforma. | 3                 | Joaquin David Rivadeneyra Ramos             | Done                                        |
|            |                                                                    | TS38             | Implementar validación de datos del vehículo registrado.                       | Guardar la información de los vehículos nuevos en la base de datos.            | 1                 | Joaquin David Rivadeneyra Ramos             | Done                                        |
| US25       | Registro Monitoreo en Tiempo Real de Vehículos<br> Nuevos Usuarios | TS39             | Crear sistema de monitoreo en tiempo real de vehículos registrados.            | Permitir que los vehículos nuevos se registren y se almacenen en el sistema.   | 3                 | Joaquin David Rivadeneyra Ramos             | Done                                        |
